...
# -*- coding: utf-8 -*-
"""
frequency-wavenumber tools

@author: jordan bishop, david fee, with some help from obspy
function(s) to compute f-k with loop over frequencies
seems to be faster than looping all frequencies in slowness space
